...
- [Empty Result Handling](../in_depth/compute-framework-integration.md#filter-column-validation) - Zero rows is always valid; a zero-column (schema-less) result raises `EmptyResultError`

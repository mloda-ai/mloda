...
- [Column discovery on a reader](data-access-patterns.md#column-discovery) - the `describe_columns` seam for inspecting what a specific data access exposes, complementary to this page's plugin-level discovery.

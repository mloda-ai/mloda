...
`EvaluationResult` is the captured matcher outcome carried by the fields above; it is importable from `mloda.core.prepare.identify_feature_group` and is not part of the public `__init__` exports.

# mloda/core Code Improvements

> **Note**: The module has been migrated from `mloda_core/` to `mloda/core/`. File paths in this document have been updated accordingly.

This document identifies 10 high-impact code improvements for mloda/core. These changes may break backwards compatibility but will significantly improve code quality, maintainability, and testability.
...
**File:** `mloda/core/abstract_plugins/compute_framework.py` (506 lines)
...
**File:** `mloda/core/runtime/run.py` (615 lines)
...
**Files:** `mloda/core/prepare/accessible_plugins.py`, multiple locations
...
**File:** `mloda/core/api/request.py` (lines 21-32)
...
**File:** `mloda/core/abstract_plugins/components/options.py`

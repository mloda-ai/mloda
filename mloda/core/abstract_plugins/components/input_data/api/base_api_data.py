...
class BaseApiData(ABC):
    ...
    Attributes:
        ...
        feature_name (str | None): The name of the feature associated with the API input.
        options (Options | None): Additional options or configurations for the API input data.
    """

...
class TransformFrameworkStep(Step):
    def __init__(
        ...
        # Consumer tokens that must all arrive before this hop's SOURCE-side cfw counts as fully
        # consumed via this hop; set post-construction by ExecutionPlan.add_tfs.

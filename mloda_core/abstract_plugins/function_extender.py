...
class _CompositeExtender(WrapperFunctionExtender):
    """Internal class that chains multiple WrapperFunctionExtenders in priority order."""

    def __init__(self, extenders: List[WrapperFunctionExtender], function_type: Optional[WrapperFunctionEnum] = None):
    ...
    def __call__(self, func: Any, *args: Any, **kwargs: Any) -> Any:
        def make_wrapper(ext: WrapperFunctionExtender, inner_func: Any) -> Any:

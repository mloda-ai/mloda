...
class TestOptions:
    ...
    def test_update_with_protected_keys_default(self) -> None:
        """Test update method with default protected keys (mloda_source_feature)."""
...
class TestProtectedKeys:
    ...
    def test_update_with_default_protected_keys(self) -> None:
        """
        Test that mloda_source_feature is protected by default.
        ...
        parent_options = Options(
            group={
                ...
                DefaultOptionKeys.mloda_source_feature: "parent_source",
            }
        )
        ...
        child_options = Options(
            group={
                ...
                DefaultOptionKeys.mloda_source_feature: "child_source",
            }
        )
        ...
        assert parent_options.group[DefaultOptionKeys.mloda_source_feature] == "parent_source"
    ...
    def test_update_without_conflicts_when_protected(self) -> None:
        ...
        parent_options = Options(
            group={DefaultOptionKeys.mloda_source_feature: "source_A", "shared": "value"}
        )

        child_options = Options(
            group={DefaultOptionKeys.mloda_source_feature: "source_B", "shared": "value"}
        )

        # This should NOT raise an error because mloda_source_feature is protected
        parent_options.update_with_protected_keys(child_options)

        # Parent's protected key value is preserved
        assert parent_options.group[DefaultOptionKeys.mloda_source_feature] == "source_A"
    ...
    def test_protected_key_only_in_child(self) -> None:
        ...
        assert DefaultOptionKeys.mloda_source_feature not in parent_options.group

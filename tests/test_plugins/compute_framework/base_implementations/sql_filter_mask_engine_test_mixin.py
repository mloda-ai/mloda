...
Extends FilterMaskEngineTestMixin with SQL-specific unit tests that verify
condition strings and their structure. The integration tests (FilterMask.build)
are inherited from the base mixin.
...
class SqlFilterMaskEngineTestMixin(FilterMaskEngineTestMixin):
    """SQL-specific tests on top of the shared FilterMask integration tests.

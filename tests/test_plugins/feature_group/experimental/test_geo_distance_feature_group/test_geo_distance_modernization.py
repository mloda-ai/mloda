...
class TestGeoDistanceModernization:
    ...
    def test_string_based_feature_creation(self) -> None:
        ...
        assert "sf_location&nyc_location__haversine_distance" in result_df.columns
        assert "point_a&point_b__euclidean_distance" in result_df.columns
        assert "origin&destination__manhattan_distance" in result_df.columns
        ...
        haversine_distances = result_df["sf_location&nyc_location__haversine_distance"]
            ...
            Feature(
                ...
                options=Options(
                    context={
                        ...
                        DefaultOptionKeys.in_features: frozenset(["sf_location", "la_location"]),
                    }
                ),
            ),
            Feature(
                ...
                options=Options(
                    context={
                        ...
                        DefaultOptionKeys.in_features: frozenset(["point_a", "point_b"]),
                    }
                ),
            ),
            Feature(
                ...
                options=Options(
                    context={
                        ...
                        DefaultOptionKeys.in_features: frozenset(["origin", "destination"]),
                    }
                ),
            ),
        ]
    ...
    def test_both_approaches_produce_equivalent_results(self) -> None:
        ...
        string_feature = Feature("point_a&point_b__euclidean_distance")
        ...
        with pytest.raises(Exception):  # Should fail during validation
            feature = Feature(
                ...
                options=Options(
                    context={
                        GeoDistanceFeatureGroup.DISTANCE_TYPE: "euclidean",
                        DefaultOptionKeys.in_features: frozenset(["point_a"]),  # Only 1 feature
                    }
                ),
            )
            api = mloda([feature], {PandasDataFrame}, plugin_collector=plugin_collector)
        ...
        with pytest.raises(Exception):  # Should fail during validation
            feature = Feature(
                ...
                options=Options(
                    context={
                        GeoDistanceFeatureGroup.DISTANCE_TYPE: "euclidean",
                        DefaultOptionKeys.in_features: frozenset(["point_a", "point_b", "origin"]),  # 3 features
                    }
                ),
            )
            api = mloda([feature], {PandasDataFrame}, plugin_collector=plugin_collector)
            ...
            feature: Feature = Feature(
                ...
                options=Options(
                    context={
                        ...
                        DefaultOptionKeys.in_features: source_features,
                    }
                ),
            )
    ...
    def test_context_parameters_dont_affect_feature_group_resolution(self) -> None:
        ...
        feature1 = Feature(
            ...
            options=Options(
                context={
                    GeoDistanceFeatureGroup.DISTANCE_TYPE: "haversine",
                    DefaultOptionKeys.in_features: frozenset(["sf_location", "nyc_location"]),
                }
            ),
        )
    ...
    def test_match_feature_group_criteria_with_property_mapping(self) -> None:
        ...
        string_feature_name = "sf_location&nyc_location__haversine_distance"
    ...
    def test_dual_approach_in_single_run(self) -> None:
        ...
        features: Features | List[str | Feature] = [
            ...
            Feature(
                ...
                options=Options(
                    context={
                        GeoDistanceFeatureGroup.DISTANCE_TYPE: "haversine",
                        DefaultOptionKeys.in_features: frozenset(["nyc_location", "la_location"]),
                    }
                ),
            ),
        ]
        ...
        assert "sf_location&la_location__haversine_distance" in result_df.columns
        assert "point_a&point_b__euclidean_distance" in result_df.columns

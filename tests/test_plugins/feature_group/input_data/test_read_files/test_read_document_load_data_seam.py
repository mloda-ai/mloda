...
# pattern (ReadDB requires produce_rows AND connect): a ReadDocument subclass is
# "final via the seam" only if produce_document AND suffix are BOTH overridden
# relative to ReadDocument.
# --------------------------------------------------------------------------------------
